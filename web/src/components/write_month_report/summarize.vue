        ...
        <el-tabs type="border-card" v-model="activeName" >
          ...
          <el-tab-pane label="规章制度" name="1">   
            <el-form ref="form1" label-width="200px">
                ...
                <el-form-item label="新增（修订）安全操作规程" prop="yearmonth"> 
                    <el-row>
                      <el-col :span="6"> 
                ...
                <el-form-item label="新增（修订）安全生产预案" prop="yearmonth"> 
                    <el-row>
                      <el-col :span="6"> 
            ...
            <el-form ref="form2" label-width="220px"> 
                ...
                <el-card class="box-card" style="margin-top:10px;">
                    ...
                    <div>
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="应持证人次" prop="num">
                                    <el-input-number v-model="form.cert_require_person_times" :step="1" :min="0" ></el-input-number>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12"> 
                                <el-form-item label="实际持证人次" prop="classify">
                                    <el-input-number v-model="form.cert_fact_person_times" :step="1" :min="0" ></el-input-number>
                                </el-form-item>
                            </el-col>
                        </el-row>                  
                        <el-form-item label="证书复审时间" prop="yearmonth"> 
                            <el-input v-model="form.cert_review_time" type="textarea"></el-input> 
                        </el-form-item>
                        <el-form-item label="未持证原因" prop="yearmonth"> 
          ...
          <el-tab-pane label="风险管控" name="3"> 
            <el-form ref="form3" label-width="200px">
                <el-row>
                    ...
                    <el-col :span="12"> 
                        <el-form-item label="风险源巡查履职率">
                            <el-input v-model="form.patrol_rate"  type="textarea"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>   
                <el-row>
                ...
                <el-form-item label="重点风险源标识公示情况" prop="yearmonth"> 
                ...
                <el-row>
                    ...
                    <el-col :span="12"> 
                        <el-form-item label="24小时修复率">
                            <el-input type="textarea" v-model="form.fire_device_repair_rate"></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>   
