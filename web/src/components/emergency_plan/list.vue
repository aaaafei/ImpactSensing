<template>
    <div>
        ...
        <el-table :data="tableData" style="width:100%;" height="450" @selection-change="handleSelectionChange"  :cell-style="{padding:'3px 0'}">
            ...
            <el-table-column label="演练计划文件名称" width="250" align="center">
            ...
            <el-table-column label="演练计划文件描述" prop="file_desc" align="center"></el-table-column>
...
/* eslint-disable */
    ...
    export default{
        ...
        methods: {
            ...
            searchDataList(){
                var url = "/emergencyDrillPlan/getPageData/" + this.page.pageNum + "/" + this.page.pageSize;
                this.$request({
                    url: url,
                    data: {},
                    method: 'POST'
            ...
            del(){
                if(this.selectUUIDs.length==0){
                  ...
                  this.$confirm('确认删除所选数据吗？','提示',{
                      ...
                      this.$request({
                        url: '/emergencyDrillPlan/delete/' + this.selectUUIDs.join(',') +"/",
                        method:'get'
                      }).then(res => {
                        this.$message({
                          type: 'success',
            ...
            handleDelete(index,rowData){
                this.$confirm('确认删除吗?', '提示', {
                    ...
                    this.$request({
                    url: '/emergencyDrillPlan/delete/' + rowData.uuid
                    }).then(res => {
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
