<template>
    <div>
        ...
        <el-table :data="tableData" style="width:100%;" height="450" @selection-change="handleSelectionChange"  :cell-style="{padding:'3px 0'}">
            ...
            <el-table-column label="部门" prop="org_name" width="200" align="center"></el-table-column>
            <el-table-column label="演练实施文件名称" width="250" align="center">
            ...
            <el-table-column label="演练实施文件描述" prop="file_desc" align="center"></el-table-column>
            <el-table-column label="上传日期" prop="upload_time" width="120" align="center"></el-table-column> 
    ...
    export default{
        ...
        data(){
            return {
                ...
                addSaveBtn: false,
                editSaveBtn: false,
                pageProps: ['uuid', 'file_path', 'file_desc'],
                form: {uuid: null, file_path: null, file_desc: null },
                fileList: []
            };
        },
        methods: {
            ...
            searchDataList(){
                var url = "/emergencyDrillImplement/getPageData/" + this.page.pageNum + "/" + this.page.pageSize;
                this.$request({
                    url: url,
                    data: {},
                    method: 'POST'
            ...
            del(){
                if(this.selectUUIDs.length==0){
                  ...
                  this.$confirm('确认删除所选数据吗？','提示',{
                      ...
                      this.$request({
                        url: '/emergencyDrillImplement/delete/' + this.selectUUIDs.join(',') +"/",
                        method:'get'
                      }).then(res => {
                        this.$message({
                          type: 'success',
            ...
            handleDelete(index,rowData){
                this.$confirm('确认删除吗?', '提示', {
                    ...
                    this.$request({
                    url: '/emergencyDrillImplement/delete/' + rowData.uuid
                    }).then(res => {
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
