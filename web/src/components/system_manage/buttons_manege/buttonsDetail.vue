    ...
    <el-dialog title="按钮详情" @close="close('')" :visible="detailVisible">
      <el-form  :model="form"  label-width="130px">
        ...
        <el-form-item label="所属菜单：" prop="menuName">
          <el-input v-model="form.menuName" readonly />
        </el-form-item>
        <el-form-item label="所属菜单编码：" prop="menuCode">
          <el-input v-model="form.menuCode" readonly />
        </el-form-item>
        <el-form-item label="备注：" prop="remark">
          <el-input v-model="form.remark" readonly />
        </el-form-item>
        <el-form-item label="排序号：" prop="sortno">
          <el-input v-model="form.sortno" readonly />
        </el-form-item>
        ...
        <el-form-item label="创建人：" prop="createUser">
          <el-input v-model="form.createUser" readonly />
        </el-form-item>
        <el-form-item label="更新时间：" prop="updateTime">
          <el-input v-model="form.updateTime" readonly />
        </el-form-item>
        <el-form-item label="更新人：" prop="updateUser">
          <el-input v-model="form.updateUser" readonly />
        </el-form-item>-->
      </el-form>
    </el-dialog>
  </div>
...
<script>
  export default {
    name: 'buttonDetailBox',
    props: ['detailVisible', 'detailForm'],
    data: function () {
      return {
