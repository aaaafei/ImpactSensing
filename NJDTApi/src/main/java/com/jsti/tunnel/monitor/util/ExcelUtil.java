...
public class ExcelUtil {
     ...
     * @Description: 自动调整列宽
     */
    public static void adjustColumnSize(HSSFSheet[] sheets, int sheetNum,
            String[] fieldNames) {
     ...
     */
    public static void creatTableHeadRow(ExcelExportData setInfo,HSSFSheet[] sheets, int sheetNum) {
        // 表头
